...
This document provides instructions and guidelines for Claude Code agents working on this project. Claude Code is designed to assist with software engineering tasks using the SpecifyPlus framework across all phases of the Todo App Hackathon.

## Project Context

- **Project Name**: Todo App Hackathon - Phase II
- **Objective**: Multi-phase todo app development with AI integration across four phases
- **Methodology**: Specification Driven Development (SDD) across all phases
- **Phases**: I (CLI), II (Full-Stack), III (AI Integration), IV (Kubernetes)
...
The project follows the SpecifyPlus framework structure across all phases:
...
- Work across all phases following the sequential development approach
- Maintain consistency between phases
...
- Regularly perform cross-phase consistency checks
...
- Keep specifications up-to-date across all phases

### 5. Quality Standards

- Follow the principles in the project constitution
- Ensure all phases meet quality standards
- Maintain security-first approach

## Best Practices

1. **Always verify prerequisites** using the check-prerequisites script
2. **Follow the SDD workflow** for all changes across phases
...
2. Examine the specifications in each phase directory
