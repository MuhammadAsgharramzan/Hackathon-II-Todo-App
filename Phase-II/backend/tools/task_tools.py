...
class TaskTools:
    ...
    @staticmethod
    def add_task(user_id: str, title: str, description: Optional[str] = None, session: Session = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if session:
                ...
                with next(get_session()) as new_session:
                    ...
                    new_session.add(db_task)
                    new_session.commit()
                    new_session.refresh(db_task)
    ...
    @staticmethod
    def list_tasks(user_id: str, status: Optional[str] = None, session: Session = None) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if session:
                ...
                with next(get_session()) as new_session:
                    ...
                    tasks = new_session.exec(statement).all()
    ...
    @staticmethod
    def update_task(user_id: str, task_id: int, title: Optional[str] = None, description: Optional[str] = None, session: Session = None) -> Optional[Dict[str, Any]]:
        """
        Modify a task
    ...
    @staticmethod
    def complete_task(user_id: str, task_id: int, session: Session = None) -> Optional[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def delete_task(user_id: str, task_id: int, session: Session = None) -> Optional[Dict[str, Any]]:
        """
        Remove a task
